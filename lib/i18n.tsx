...
const translations: Record<Language, Translation> = {
  EN: {
    ...
    about: { title: 'Engineering the future,', highlight: 'one line of code at a time.', p1: "I'm a passionate Software Engineer based in Izmir, TR, dedicated to building scalable and user-centric digital products.", p2: "Whether I'm architecting complex backend systems with Node.js and Python, or crafting buttery-smooth user interfaces with React and Tailwind, I always strive for excellence.", years: 'Years Coding', shipped: 'Projects Shipped', coffee: 'Coffee Fueled' },
  ...
  TR: {
    ...
    about: { title: 'Geleceği tasarlıyorum,', highlight: 'her satır kodla birlikte.', p1: "İzmir merkezli, ölçeklenebilir ve kullanıcı odaklı dijital ürünler geliştirmeye adamış tutkulu bir Yazılım Mühendisiyim.", p2: "Node.js ve Python ile karmaşık arka uç sistemleri mimarisi oluştururken veya React ve Tailwind ile akıcı kullanıcı arayüzleri hazırlarken her zaman mükemmelliği hedeflerim.", years: 'Yıl Kodlama', shipped: 'Proje Bitti', coffee: 'Kahve Tüketimi' },
